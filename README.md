...
* a framework for analysing:
  ...
  * **pseudo-symmetry**, **residual stabilization**, and **reciprocity loss** as scene-bound structural configurations,
...
* **Pseudo-Symmetry (PS)** is a stable substitution regime within this reconstruction:
  ...
  * reciprocity becomes structurally compromised as coordinated asymmetry cannot consolidate.
...
Named labels in PMS–EDEN are **paper-internal structural composites**, not ontological object-types, not diagnoses, and not additional PMS operators.
...
### 6. Reciprocity as Coordinated Asymmetry
...
* and Χ to limit escalation and preserve reversibility.

### 7. Pattern Library and Drift Recognition
...
* and forbids person-evaluation, diagnosis, and coercive prescription.
...
> **EDEN → THRESHOLD → NRK → □comparison → PS → residual stabilization (Λ/Φ/Α) → (DEVALUATION | HUMILIATION) → RECIPROCITY_LOSS**
...
(e.g. minimal Ω, praxis-dominant □, early Σ / Ψ, institutional scaffolding),
...
2. `model/PMS-EDEN.yaml` (overlay: master trace, EDEN-MAP, pattern library, drift, boundaries)
3. `PMS–EDEN - Structural Drift from Praxis to Comparison, Pseudo-Symmetry, and Reciprocity Loss.html`
4. Example Suite (scene-bound structural stress tests)
...
HTML for stable human-readable access, YAML for machine-readable overlay and example structures.
...
They function as **structural stress tests**, not illustrations or prescriptions.
...
* or prescriptive use of drift labels against persons or groups.

Any use as guidance must respect the **application gate**:
...
PMS–EDEN is embedded in a broader **praxeological ecosystem** spanning formal operator theory,
applied anthropology, structural drift analysis, and executable model specifications.
...
When referencing PMS–EDEN, please cite both PMS–EDEN and PMS:

**PMS–EDEN**

> T. Zöller (2026):
> *PMS–EDEN — Structural Drift from Praxis to Comparison, Pseudo-Symmetry, and Reciprocity Loss.*
...
* clarifications to drift, boundary-condition, or pattern formulations,
...
* revisions that improve discriminative adequacy, scope clarity, and non-capture discipline.

Out of scope:

* introducing new operators,
* redefining PMS dependencies,
* person-typing, diagnosis, or motive attribution,
* turning drift labels into enforcement or sanction logic,
* instructional or prescriptive content,
* treating paper-internal composites as if they were canonical PMS primitives.

---

## License

Unless otherwise stated, all documentation in this repository is governed by the license declared in:
