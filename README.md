...
2. `model/PMS-EDEN.yaml` (overlay: updated master trace, EDEN-MAP Q1–Q7, switch-drift markers, pattern library, drift, viability, boundaries)
3. `model/Model Specification.html` (human-readable technical specification)
4. `PMS–EDEN - Structural Drift from Praxis to Comparison, Pseudo-Symmetry, and Reciprocity Loss.html`
5. Example Suite (scene-bound structural stress tests)
...
* maps relevant switch-drift markers where they appear,
* enforces the **PMS application gate (Χ + reversibility + D)**.

Included cases:

1. **Pseudo-Symmetry under Real Cost Asymmetry**
   *Equality rhetoric as frame substitution under Ω and Θ; PS as preparation for asymmetry-switch availability.*

2. **Mediation Termination vs. Mediation Compulsion**
   *Why ending mediation can be cost-rational rather than a character failure; mediation as possible switch surface.*

3. **Teaches Nothing vs. the Learning / Transgression Myth**
   *Threshold acts as consequence-legibility without epistemic gain; downstream drift does not retroactively justify breach.*

4. **Fig Leaves / Legibility Management Without Psychology**
   *Exposure management and script stabilization without shame or guilt models; switch drift only as downstream risk.*

5. **Who Goes First? as Trajectory Origin, Not Moral Rank**
   *Sequence effects, origin asymmetry, and irreversibility without blame; origin as possible parity-to-exit or responsibility-to-authority surface.*

The Example Suite trains **structural reading discipline**:
how to keep **Λ, Ω, Θ, Χ, Σ, Ψ, and switch drift** visible without collapsing into verdicts.
...
applied anthropology, structural drift analysis, governance analysis, and executable model specifications.
...
> *PMS-EDEN.yaml — Paper-Specific Application Profile (Overlay), schema_version PMS-EDEN_1.2.*
